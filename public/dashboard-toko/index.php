...
<div class="table-responsive card m-5 p-5">
    <table class="table text-center">
        <thead>
            <p class="fs-5 text-body-secondary">Transaksi Pembelian</p>
            <tr>
                    ...
                    if(!empty($hasil1)){
                        foreach($hasil1 as $item1){ 
                            ...
                            <tr>
                                ...
                                <td>
                                    <?= $item1->total_harga; ?> 
                                    <div class="text-muted small">(<?= $item1->jumlah_item; ?> item)</div>
                                </td>
                                ...
                                <td>
                                    <?= ($item1->status == 'selesai' || $item1->status == 'Sudah Selesai') ? 'Sudah Selesai' : 'Belum Selesai'; ?>
                                </td>
